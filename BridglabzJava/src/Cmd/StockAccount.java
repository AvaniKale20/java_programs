...
static File customerDetail=new File("/home/user/Documents/program/avani/BridglabzJava/src/Cmd/Customer.json");
static File customerShare=new File ("/home/user/Documents/program/avani/BridglabzJava/src/Cmd/CompanyShares.json");
 ...
 ******************************************************/
	public static int add() {
		try {
			 ...
			 */
			List<Customer> customerList = objectmapper.readValue(new File("//home/user/Documents/program/avani/BridglabzJava/src/Cmd/Customer.json"),new TypeReference<List<Customer>>() {});
			/**
			...
			if (indexNumber== -1) {
				 ...
				 */
				StockAccount.save("/home/user/Documents/program/avani/BridglabzJava/src/Cmd/Customer.json", customerList);
				System.out.printf("\n%-15s %-20s %-20s %-20s\n", "Cust. Name", "TCS(Shares)", "TATA(Shares)","MAHENDRA(Shares)");
				System.out.println();
 ...
 */
	...
	public static int addCompany() {
		try {
			 ...
			 * HERE WE ARE READING OUR FILE IF IT IS HAVING ANY DATA INSIDE THEN WE ARE GOING TO PUT IT ON LIST COLLECTION ARRAY
			 */
			List<CompanyShares> companyList = objectmapper.readValue(new File("/home/user/Documents/program/avani/BridglabzJava/src/Cmd/CompanyShares.json"),new TypeReference<List<CompanyShares>>() {});
			/**
			 * HERE WE ARE TESTING(PRINTING) IS DATA ARE STORE OR NOT INSIDE THE LIST ARRAY
			 */
			...
			companyList.add(companyShare);
				 ...
				 * HERE WE ARE SAVING DATA
				 */
				StockAccount.saveCompany("/home/user/Documents/program/avani/BridglabzJava/src/Cmd/CompanyShares.json", companyList);
